                                ...
                                <table class="table table-striped" id="datatable">
                                    ...
                                    <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td width="5%"><?php echo e(1 + $key); ?></td>
...
<?php $__env->startSection('additionalAction'); ?>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create-' . $route_index)): ?>
        <a href="<?php echo e(route($route_index . '.create')); ?>" class="btn btn-label-brand btn-bold btn-sm btn-icon-h kt-margin-l-10" data-toggle="kt-tooltip" title="Tambah" data-placement="bottom">
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MAMP\htdocs\evote\resources\views/backend/teams/index.blade.php ENDPATH**/ ?>