                                ...
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body">
                                                ...
                                                <div class="tab-content">
                                                    @foreach($languages as $key => $language)
                                                        <div class="tab-pane {{ $key == 0 ? 'active' : '' }}" id="lang_{{ $language->locale }}" role="tabpanel">
                                                            ...
                                                            <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" name="name[{{ $language->locale }}]" type="text"  placeholder="Name">
                                                            @if($errors->has('name'))
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <input class="form-control {{ $errors->has('slug') ? 'is-invalid' : '' }}" name="slug" type="text" value="{{ old('slug') }}"  placeholder="Slug">
                                                @if($errors->has('slug'))
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <input class="form-control {{ $errors->has('route_name') ? 'is-invalid' : '' }}" name="route_name" type="text" value="{{ old('route_name') }}"  placeholder="Route Name">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <input class="form-control {{ $errors->has('icon') ? 'is-invalid' : '' }}" name="icon" type="text" value="{{ old('icon') }}"  placeholder="Icon">
                                                @if($errors->has('icon'))
                                    ...
                                    <div class="kt-section__body">
                                        ...
                                        <div id="permission_repeater">
                                            <div id="list_reapeater">
                                                <div class="form-group row">
                                                    <div class="col-10">
                                                        <input class="form-control {{ $errors->has('permission_name') ? 'is-invalid' : '' }}" name="permission_name[]" type="text" value="Read"  placeholder="Name" required>
