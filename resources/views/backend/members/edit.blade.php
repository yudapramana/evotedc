                        ...
                        <div class="kt-section kt-section--first">
                            <div class="kt-section__body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <input class="form-control {{ $errors->has('student_number') ? 'is-invalid' : '' }}" name="student_number" type="text" value="{{ old('student_number', $detail->student_number) }}"  placeholder="Student Number" required>
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <select class="form-control {{ $errors->has('study_id') ? 'is-invalid' : '' }}" name="study_id" required>
                                            ...
                                            @foreach($studies as $item)
                                                <option value="{{ $item->id }}" {{ old('study_id', $detail->study_id) == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <input class="form-control {{ $errors->has('faculty') ? 'is-invalid' : '' }}" name="faculty" type="text" value="{{ old('faculty', $detail->faculty) }}"  placeholder="Faculty" required>
