                        ...
                        <div class="kt-section kt-section--first">
                            <div class="kt-section__body">
                                    ...
                                    <div class="col-lg-9 ">
                                        <div class="form-group">
                                            <div class="kt-avatar kt-avatar--outline embed-responsive" id="kt_user_avatar_1" style="width: 138px; height: 138px;">
                                                <img class="embed-responsive-item" src="{{ old('image') }}" id="holder" style="width: 138px; height: 138px;object-fit: cover;">
                                                <label class="kt-avatar__upload" id="lfm" data-input="thumbnail" data-preview="holder">
                                                    <i class="fa fa-pen"></i>
                                                    <input type="hidden" name="image" value="{{ old('image') }}" id="thumbnail">
                                                </label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 ">
                                        <input class="form-control {{ $errors->has('number') ? 'is-invalid' : '' }}" name="number" type="number" value="{{ old('number') }}"  placeholder="Nomor Urut" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-9">
                                        <input class="form-control {{ $errors->has('study') ? 'is-invalid' : '' }}" name="study" type="text" value="{{ old('study') }}"  placeholder="Pendidikan" required>
                                        @if($errors->has('study'))
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-9">
                                        <input class="form-control {{ $errors->has('faculty') ? 'is-invalid' : '' }}" name="faculty" type="text" value="{{ old('faculty') }}"  placeholder="Fakultas" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 ">
                                        <textarea class="form-control {{ $errors->has('vision') ? 'is-invalid' : '' }}" name="vision" rows="8" placeholder="Visi" required>{{ old('vision') }}</textarea>
