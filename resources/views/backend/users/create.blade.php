                        ...
                        <div class="kt-section kt-section--first">
                            <div class="kt-section__body">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <div class="form-group">
                                            <div class="kt-avatar kt-avatar--outline embed-responsive" id="kt_user_avatar_1" style="width: 138px; height: 138px;">
                                                <img class="embed-responsive-item" id="image" style="width: 138px; height: 138px;object-fit: cover;">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <input class="form-control {{ $errors->has('first_name') ? 'is-invalid' : '' }}" name="first_name" type="text" value="{{ old('first_name') }}"  placeholder="First Name" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <input class="form-control {{ $errors->has('last_name') ? 'is-invalid' : '' }}" name="last_name" type="text" value="{{ old('last_name') }}"  placeholder="Last Name" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <input class="form-control {{ $errors->has('username') ? 'is-invalid' : '' }}" name="username" type="text" value="{{ old('username') }}"  placeholder="User Name" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <input class="form-control {{ $errors->has('password') ? 'is-invalid' : '' }}" name="password" type="password" value="{{ old('password') }}"  placeholder="Password" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <input class="form-control {{ $errors->has('confirm_password') ? 'is-invalid' : '' }}" name="confirm_password" type="password" value="{{ old('confirm_password') }}"  placeholder="Retype Password" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" name="phone" type="number" value="{{ old('phone') }}"  placeholder="Phone">
                                        @if($errors->has('phone'))
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <textarea class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" name="address" rows="3" placeholder="Address">{{ old('address') }}</textarea>
