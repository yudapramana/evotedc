...
<div class="container m-auto mt-20 md:mt-18">
    ...
    <form id="voteform" method="post" action="{{ route('home.vote.store') }}" class="form-vote">
        ...
        <h2 class="text-center text-4xl font-extrabold font-serif italic pt-4 pb-8 mb-4">SUKSESI HIMPUNAN {{
            strtoupper($jurusan) }} FEB UNDIP 2023 </h2>
        <div class="flex flex-wrap justify-center">
            ...
            <div class="py-2 px-2 w-full md:w-1/2">
                ...
                <div class="rounded-large overflow-hidden shadow-lg bg-white">
                    <div
                        class="kandidat-container @if ($jurusan == 'Manajemen') manajemen @endif @if ($jurusan == 'Akuntansi') akuntansi @endif @if ($jurusan == 'Ekonomi Islam') ekonomi-islam @endif @if ($jurusan == 'Ekonomi') ekonomi @endif">
                        <p class="text-center pt-24 text-white px-6 text-2xl mx-auto"
                            style="font-family: 'Courier New', Courier, monospace!important">{{ $item->name }}</p>
                    </div>
                    <div class="object-center h-10 mt-8 flex">
