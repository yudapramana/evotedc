...
@section('content')
    ...
    <nav class="navbar relative justify-center">
        ...
        @if ($jurusan == 'Manajemen')
            <div>
                <img class="h-32" src="https://res.cloudinary.com/kemenagpessel/image/upload/v1669613484/eVote/LOGO_MSA_avawfa.png" alt="Manajemen">
            </div>
        @endif
        @if ($jurusan == 'Ekonomi')
            <div>
                <img class="h-32" src="https://res.cloudinary.com/kemenagpessel/image/upload/v1669613484/eVote/LOGO_-_DESC_crng1v.png" alt="Ekonomi">
            </div>
        @endif
        @if ($jurusan == 'Ekonomi Islam')
            <div>
                <img class="w-32 h-32" src="https://res.cloudinary.com/kemenagpessel/image/upload/v1669613484/eVote/LOGO_HMEI_vzjat9.png" alt="Ekonomi Islam">
            </div>
        @endif
        @if ($jurusan == 'Akuntansi')
            <div>
                <img class="w-32 h-32" src="https://res.cloudinary.com/kemenagpessel/image/upload/v1669613484/eVote/Logo_KMA-1_hpozjc.png" alt="Akuntansi">
            </div>
        @endif
        ...
        <div class="pb-2 pl-5" style="font-family:'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif; font-weight:bolder;">
            ...
            <span class="text-3xl gr-dark-orange text-black">FAKULTAS EKONOMIKA DAN BISNIS UNDIP 2022</span> <br>
        </div>
        {{-- </a> --}}
    ...
    <div class="container m-auto mt-20 md:mt-18">
        @if (!session('finish_vote'))
            <form id="voteform" method="post" action="{{ route('home.vote.store2') }}" class="form-vote">
                ...
                <h3 class="text-center text-4xl font-extrabold font-serif italic pt-4 pb-8 mb-4">Silakan Pilih Calon Ketua Himpunan {{ strtoupper($jurusan) }} sesuai pilihanmu! </h3>
